...
const updateScore = () => {
    setTimeout(() => {
        ...
        const restartGame = document.getElementById('greaterDivForRestartButtonandText');
        const congrat = document.getElementById('greaterDivForCongratulationsButtonandText');
